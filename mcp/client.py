...
class mcp_client():
    def __init__(self):
        ...
        #again not sure if another AI can go here 
    ...
    async def connect_to_server(self, server_script_path: str):
        ...
        http_transport = await self.exit_stack.enter_async_context(streamable_http_client("http://127.0.0.1:8000/mcp"))
        self.session = await self.exit_stack.enter_async_context(ClientSession(http_transport[0], http_transport[1]))
