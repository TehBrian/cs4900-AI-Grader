...
class Course(models.Model):
    ...
    course_code = models.CharField(max_length=20, help_text="e.g., MATH 1220, ENGR 2130")
...
class QuizProblem(models.Model):
    ...
    """
    quiz = models.ForeignKey(Quiz, on_delete=models.CASCADE, related_name='quiz_problems')
...
class QuizStatistics(models.Model):
    ...
    """
    quiz = models.OneToOneField(Quiz, on_delete=models.CASCADE, related_name='statistics')
    ...
    grade_distribution = models.JSONField(
        default=dict,
        help_text="Grade distribution: {'A': count, 'B': count, ...}"
    )
