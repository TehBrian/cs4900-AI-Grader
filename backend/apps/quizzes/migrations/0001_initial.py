# Generated by Django 4.2.7 on 2025-09-28 18:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "course_code",
                    models.CharField(
                        help_text="e.g., MATH 1220, ENGR 2130", max_length=20
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "available_from",
                    models.DateTimeField(help_text="When quiz becomes available"),
                ),
                (
                    "available_until",
                    models.DateTimeField(help_text="When quiz becomes unavailable"),
                ),
                (
                    "max_attempts",
                    models.PositiveIntegerField(
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Allow students to review after submission",
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="quizzes.CourseEnrollment",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        default=list,
                        help_text="Randomized problem order for this attempt",
                    ),
                ),
                (
                    "problem_parameters",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        ...
                        name="quiz_attemp_status_396e4e_idx",
                    ),
                ],
        ...
        migrations.AddIndex(
            model_name="quiz",
            index=models.Index(
                fields=["course", "is_published"], name="quizzes_course__98b22b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="quiz",
            index=models.Index(
                ...
                name="quizzes_availab_e3a10c_idx",
            ),
        ),
