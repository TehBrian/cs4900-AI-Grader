...
class Problem(models.Model):
    ...
    difficulty = models.CharField(
        max_length=20, choices=DIFFICULTY_LEVELS, default="intermediate"
    )
    ...
    allow_equivalent_forms = models.BooleanField(
        default=True, help_text="Allow mathematically equivalent expressions"
    )
    ...
    author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="authored_problems"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    is_template = models.BooleanField(
        default=False, help_text="Can be used as template for new problems"
    )
...
# Import ProblemInstance model
from .models_instance import ProblemInstance


# Enhance ProblemTemplate with additional methods
def _enhance_problem_template():
    """Add methods to ProblemTemplate after it's defined"""
    from . import models_additions


_enhance_problem_template()
