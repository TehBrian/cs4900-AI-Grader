...
from .models import ProblemCategory, Problem, ProblemPart, ProblemTag, ProblemTagging, ProblemTemplate
...
class ProblemListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Problem
        fields = ['id', 'title', 'category', 'category_name', 'difficulty', 'created_at']
